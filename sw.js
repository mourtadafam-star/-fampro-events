const CACHE='fampro-events-v99';
const ASSETS=['./','./index.html','./admin-workflows.js?v=99','./login.html','./client.html','./manifest.webmanifest','./client.webmanifest','./092508DF-3780-43EC-8976-384F9EF65BE0.png'];
